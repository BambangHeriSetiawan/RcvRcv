...
public class AdapterRcvCACA extends RecyclerView.Adapter<AdapterRcvCACA.Holder> {
  private Context mContext;
  private List<String>mList;
  private Listener listener;
  public AdapterRcvCACA(Context mContext, List<String> mList,Listener listener) {
